...
describe("recma-mdx-html-override, output is function-body, without plugin, jsx is true", () => {
  // ******************************************
  it("without plugin, only html raw element", async () => {
    ...
    const compiledSource = await compile(source, { outputFormat: "function-body", jsx: true });
...
describe("recma-mdx-html-override, output is function-body, with plugin, jsx is true", () => {
  // ******************************************
